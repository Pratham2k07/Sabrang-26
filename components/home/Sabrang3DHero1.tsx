...
// ── Fixed Camera Rig (Hero 1 Preset) ────────────────────────────────────────
...
function CameraRig() {
  ...
  useFrame(({ camera, clock }) => {
    ...
    const driftY = Math.cos(t * 0.35) * 0.04;

    // Fixed camera distance Z = 13.0
    targetPos.current.set(driftX, driftY, 13.0);
...
// ── Sabrang3DHero1 (Saved Preset Hero 1) ────────────────────────────────────

export default function Sabrang3DHero1() {
      ...
      <div ref={stickyRef} className="sticky top-0 w-full h-screen overflow-hidden bg-[#030008]">
        ...
        <div className="absolute inset-0 z-[5] pointer-events-none">
          ...
          >
            ...
            <SabrangSculpture1 position={[0, 0, 0]} scale={1.05} />
            <FloatingArtElements />
